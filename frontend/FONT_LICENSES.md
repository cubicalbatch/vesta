...
Vesta bundles these typefaces as static `.woff2` assets (no network fetch at
runtime). Each is distributed under the SIL Open Font License 1.1, reproduced in
full below. The copyright notices and license text are kept here so they travel
with the font files, as the OFL requires.

| Typeface | Role | Package | Source |
| --- | --- | --- | --- |
| Inter | UI / body text | `@fontsource-variable/inter` | https://github.com/rsms/inter |
| Bitter | Display / hero + page headlines | `@fontsource/bitter` | https://github.com/solmatas/BitterPro |
...
Bitter-Italic[wght].ttf: Copyright 2011 The Bitter Project Authors
